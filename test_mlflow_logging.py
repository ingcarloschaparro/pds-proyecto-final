#!/usr/bin/env python3
"""Script de prueba para verificar que MLflow logging funciona correctamente"""
...
mlflow.set_experiment("E2-Test-Logging")

def test_mlflow_logging():
    """Prueba el logging de MLflow con un modelo simple"""
    
    with mlflow.start_run(run_name="test_logging_run"):
        print("=== PRUEBA DE LOGGING MLFLOW ===")
